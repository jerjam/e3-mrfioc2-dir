...
#include "timseqstVersion.h"

/* must be last include */
#include "epicsExport.h"

const char version[] = timseqstVERSION;
...
static lsidset devtimseqstVersion = {
    5, NULL, NULL, NULL, NULL, read_string
};
epicsExportAddress(dset,devtimseqstVersion);
